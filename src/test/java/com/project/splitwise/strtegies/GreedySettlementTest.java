package com.project.splitwise.strtegies;
...
import strategies.GreedySettlementStrategy;
...
public class GreedySettlementTest {
    ...
    @BeforeEach
    public void setUp() {
        settlementStrategy = new GreedySettlementStrategy();//lose coupling
    ...
    private Expense expense(Double amount, Map<Long, Double> owedBy, Map<Long, Double> paidBy) {
        ...
        expense.setOwedBy(castExpenseMap(expense, owedBy, ExpenseType.OWNED));
